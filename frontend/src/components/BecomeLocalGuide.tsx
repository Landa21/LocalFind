                ...
                <div className="bg-sand/30 rounded-3xl overflow-hidden flex flex-col md:flex-row shadow-lg">
                    ...
                    <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center">
                        <h2 className="font-serif text-3xl md:text-4xl text-gray-900 mb-6 leading-tight">
                            Share Your World <br /> with Travelers
                        </h2>
                        <p className="text-gray-700 text-lg mb-8 leading-relaxed">
                            Subscribe to promote your unique offerings to a growing community of explorers. Gain visibility, manage your listings, and grow your local business with our dedicated platform.
                        </p>

                        <div className="flex flex-col gap-3 mb-10">
                            {[
                                'Manage listings with a dedicated Owner Dashboard',
                                'Gain visibility with featured placement options',
                                'Track performance with views and save analytics'
                            ].map((benefit, index) => (
...
export default BecomeLocalGuide;
