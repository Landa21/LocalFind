...
import { cn } from "../../lib/utils"; // Updated path for shadcn project
...
export function CardStack<T extends CardStackItem>({
    ...
    const activeItem = items[active]; // Remove strict null assertion if needed, but here fine since we check len
        ...
        >
            ...
            {showDots ? (
                <div className="mt-6 flex items-center justify-center gap-3">
                            ...
                            return (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        on
                                            ? "bg-foreground bg-orange-500" // Added orange-500 for demo
                                            : "bg-foreground/30 hover:bg-foreground/50 bg-gray-300", // Added gray-300 for demo
                                    )}
                    ...
                    {activeItem?.href ? (
                        <Link
                            to={activeItem.href} // Changed href to to for Router Link
                            target="_blank"
                            rel="noreferrer"
